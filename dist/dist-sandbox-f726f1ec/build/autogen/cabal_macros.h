...
/* package SQL-lexical-analyzer-0.1.0.0 */
#define VERSION_SQL_lexical_analyzer "0.1.0.0"
#define MIN_VERSION_SQL_lexical_analyzer(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "SQL-lexical-analyzer-0.1.0.0-4ujujVgJhiyHEfcH6GgXOc"

#define CURRENT_PACKAGE_KEY "4ujujVgJhiyHEfcH6GgXOc"
